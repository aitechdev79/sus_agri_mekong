            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
              ...
              <div className="md:col-span-2 p-8">
                <h1 className="font-montserrat font-bold text-3xl md:text-4xl text-gray-800 mb-8 text-left">
                  {isEn ? 'Vision & Mission' : 'Tầm nhìn sứ mệnh'}
                </h1>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat mb-4">
                    {isEn
                      ? 'The portal is an initiative by VCCI-HCM, established to provide reliable, transparent, and accurate data and information as a foundation for Vietnam’s sustainable development future.'
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat">
                    {isEn
                      ? 'We connect Vietnam’s business ecosystem through transparent data, practical experience, and updated policy information to drive sustainable growth and international integration.'
                ...
                <div className="mb-6">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat mb-4">
                    {isEn
                      ? 'Our mission is to work alongside businesses and communities to improve competitiveness, strengthen labor conditions, promote responsible business, and create long-term social value.'
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat">
                    {isEn
                      ? 'Through multi-stakeholder collaboration, we aim for a future where Vietnamese businesses are sustainable, transparent, and trusted.'
                ...
                <div className="mb-6">
                  <h2 className="font-montserrat font-bold text-2xl text-gray-800 mb-4">
                    {isEn ? 'ESG Direction' : 'Định hướng ESG'}
                  </h2>
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat mb-4">
                    {isEn
                      ? 'We position ESG (Environmental, Social, and Governance) as a core direction in our development strategy. ESG reflects business responsibility to communities and the environment while strengthening governance, competitiveness, and credibility.'
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat">
                    {isEn
                      ? 'By promoting ESG adoption, we encourage Vietnamese businesses to embed sustainability into long-term strategy, improve competitiveness, and contribute to national development goals.'
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <p className="text-base text-gray-700 leading-relaxed font-montserrat">
                    {isEn
                      ? 'Through the PPP mechanism, this platform is not only a data repository but also a trusted bridge where stakeholders share responsibility, connect resources, and co-create value. This is the foundation for a comprehensive sustainability ecosystem in which all social actors are heard, involved, and benefit together.'
              ...
              <div className="md:col-span-1 self-start md:sticky md:top-1/2 md:-translate-y-1/2">
                ...
                <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-700 font-montserrat leading-relaxed">
                      {isEn
                        ? 'Legal frameworks, policy direction, and sustainability strategies that create an enabling environment for business and society.'
                ...
                <div className="flex items-start gap-4 p-4 bg-pink-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-700 font-montserrat leading-relaxed">
                      {isEn
                        ? 'Oversight, transparency, and diffusion of sustainable values across communities to create positive social impact.'
