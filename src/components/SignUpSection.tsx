...
export default function SignUpSection() {
  ...
  const partnerLogos = [
    ...
    { id: 'loctroi', name: 'Loc Troi', logo: '/06-loctroi.png' },
    { id: 'binhdien', name: 'Binh Dien', logo: '/03-binhdien.jpg' },
    { id: 'cp', name: 'CP', logo: '/02-CP.jpg' },
    { id: 'vietfood', name: 'Vietfood', logo: '/vietfood.png' },
    { id: 'agribank', name: 'Agribank', logo: '/Agribank.png' },
    { id: 'phan-bon-ca-mau', name: 'Phan bon Ca Mau', logo: '/phan bon ca mau.png' }
  ];
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {partnerLogos.slice(0, 4).map((partner) => (
              <div key={partner.id} className="bg-white rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-105" style={{ border: '1px solid rgba(0, 0, 0, 0.1)', padding: '24px', maxHeight: '120px' }}>
