...
export default function HeroSectionSimple() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Solid background as base */}
        <div className="absolute inset-0 bg-gradient-to-r from-green-700 to-green-600" />

        {/* Try simple image path */}
        <img
