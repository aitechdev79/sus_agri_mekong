            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
              ...
              <div className="md:col-span-2 p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat mb-4 text-justify">
                    {isEn
                ...
                <div className="mb-6">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat mb-4 text-justify">
                    {isEn
                      ...
                      : 'Chúng tôi xem ESG (Môi trường – Xã hội – Quản trị) là định hướng trọng tâm trong chiến lược phát triển. Với chúng tôi, phát triển bền vững không dừng lại ở trách nhiệm với cộng đồng hay môi trường, mà chính là nền tảng của quản trị hiện đại – chìa khóa để kiến tạo giá trị khác biệt và khẳng định uy tín trên trường quốc tế. Bằng việc lan tỏa tinh thần ESG, chúng tôi khát vọng đồng hành cùng các doanh nghiệp Việt Nam chuyển mình mạnh mẽ.'}
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed font-montserrat text-justify">
                    {isEn
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <p className="text-base text-gray-700 leading-relaxed font-montserrat text-justify">
                    {isEn
              ...
              <div className="md:col-span-1 self-start flex flex-col gap-6 md:sticky md:top-24 lg:top-1/2 lg:-translate-y-1/2">
                ...
                <div className="flex items-start gap-4 p-4 bg-green-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-700 font-montserrat leading-relaxed text-justify">
                      {isEn
