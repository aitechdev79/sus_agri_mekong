...
export default function HeroSectionFixed() {
  ...
  // Fallback images from external sources (temporary solution)
  const fallbackImages = {
    desktop: 'https://images.unsplash.com/photo-1500595046743-cd271d694d30?w=1920&h=1080&fit=crop&crop=center&auto=format&q=80',
    mobile: 'https://images.unsplash.com/photo-1500595046743-cd271d694d30?w=800&h=1000&fit=crop&crop=center&auto=format&q=80'
  };

  // Try local images first, fallback to external
  const getImageSrc = () => {
    if (imageError) {
      return isMobile ? fallbackImages.mobile : fallbackImages.desktop;
    }
    return isMobile ? '/hero/hero-mobile.jpg' : '/hero/hero-main.jpg';
  };
