      ...
      <div className="relative flex h-full min-h-[75vh] items-center pt-16" style={{ zIndex: 10 }}>
        <div className="max-w-6xl px-6 w-full mx-auto">
          <div className="max-w-2xl">
            ...
            <div className="mb-6">
              <h1 className="font-montserrat font-bold text-left text-vn-gold" style={{ lineHeight: '1.1', letterSpacing: '0.5px' }}>
            ...
            {/* Subheadline */}
            <div className="mb-8">
              <p className="font-montserrat font-bold text-lg md:text-xl text-vn-gold leading-relaxed">
